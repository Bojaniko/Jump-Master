...
namespace JumpMaster.Obstacles
{
    ...
    public class Missile : Obstacle<MissileSO,  MissileSpawnSO, MissileSpawnMetricsSO, MissileSpawnArgs>
    {
        ...
        private void EndWarning()
        {
            ...
            AudioController.Instance.PlayLoopSound<MissileThrustSFXSourceController>(Data.ThrustSFX, new MissileThrust_SFX_SC_Args(gameObject, Data.ThrustSFX, SpawnArgs.Direction));
