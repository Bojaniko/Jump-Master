...
{
    public abstract class ObstacleController<ObstacleType, ObstacleScriptableObject, SpawnScriptableObject, SpawnMetricsScriptableObject> : IObstacleController
        ...
        where SpawnMetricsScriptableObject : SpawnMetricsSO<ObstacleScriptableObject, SpawnScriptableObject>
    {
        protected ObstacleController(SpawnMetricsScriptableObject default_spawn_metrics)
        {
            ...
            Pool = new(DefaultSpawnMetrics.Data, DefaultSpawnMetrics.MaxActiveObstacles);
        ...
        public void TrySpawn()
        {
            ...
            if (CanSpawn())
            {
                SpawnScriptableObject spawnData = _spawnMetrics.GetRandomSpawnData();
                SpawnArgs args = GenerateSpawnArguments(spawnData);
                if (args == null)
                    return;
                ObstacleType spawn = SpawnFromPool(spawnData, args);
                PostSpawn(spawn);
            }
        }
        /// <summary>
        ...
        /// </summary>
        protected abstract SpawnArgs GenerateSpawnArguments(SpawnScriptableObject spawn_data);
        /// <summary>
        ...
        private readonly ObstaclePool<ObstacleType> Pool;
        ...
        private ObstacleType SpawnFromPool(SpawnScriptableObject spawn_data, SpawnArgs spawn_args)
        {
            ObstaclesSpawned++;
            LastSpawnTime = Time.time;
